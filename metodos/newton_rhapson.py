...
class MetodoNewtonRhapson:
    ...
    def funcaoIteracao(self, c, q):
        return q - self.funcaoObjetivo(self.c, q)/self.funcaoDerivada(self.c, q)
    ...
    def tabela(self, k, q_next, e):
        ...
        table_data['Erro'][0] = e
        table_data['f(Q1)'][0] = self.funcaoObjetivo(self.c, q_next)
    ...
    def executar(self):
        ...
        ax.set_title("Convergência do Newton-Rhapson")
